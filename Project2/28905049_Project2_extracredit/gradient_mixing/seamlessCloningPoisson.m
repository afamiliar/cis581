...
[R_b]  = getSolutionVect(indexes, sourceImg(:,:,1), targetImg(:,:,1), offsetX, offsetY);
[G_b]  = getSolutionVect(indexes, sourceImg(:,:,2), targetImg(:,:,2), offsetX, offsetY);
[B_b]  = getSolutionVect(indexes, sourceImg(:,:,3), targetImg(:,:,3), offsetX, offsetY);
